...
/* Compile: gcc vmdisplay-stream.c -o vmdisplay-stream `pkg-config --cflags --libs gstreamer-1.0` */
...
main (int argc, char *argv[])
{
  ...
  data.pipeline =
      gst_parse_launch
      ("vmdisplaysrc ! video/x-raw,format=BGRx,width=3440,height=1440 ! "
      "vaapipostproc format=nv12 ! vaapih264enc  tune=low-power ! "
      "filesink location=sample.264", &err);
